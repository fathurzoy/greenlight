...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtp-username", "eb6adbcac0cbab", "SMTP username")
	flag.StringVar(&cfg.smtp.password, "smtp-password", "75c9348a74ca80", "SMTP password")
